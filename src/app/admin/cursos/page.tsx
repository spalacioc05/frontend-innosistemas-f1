      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Crear Curso de Ingeniería
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Agrega un nuevo curso para la gestión de equipos de desarrollo de estudiantes
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
            <div className="px-8 py-6 bg-gradient-to-r from-blue-500 to-indigo-600">
              <h2 className="text-2xl font-bold text-white">Información del Curso</h2>
              <p className="text-blue-100 mt-1">Complete los siguientes campos para crear el nuevo curso</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="px-8 py-8 space-y-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Ingrese un nombre descriptivo y único para el curso
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-gray-100">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center items-center py-4 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold text-lg rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-200 disabled:cursor-not-allowed transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:transform-none"
                >
                  {loading ? (
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <ul className="list-disc pl-5 space-y-1">
                    <li>El nombre del curso debe ser único en el sistema</li>
                    <li>Una vez creado, el curso estará disponible para asignar estudiantes</li>
                    <li>Solo se requiere el nombre del curso para crearlo</li>
                  </ul>
                </div>
              </div>
            </div>
